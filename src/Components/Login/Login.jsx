        ...
        <div className="signin">
          <div className="blk1_cont">
            ...
            <form onsubmit="" className="signInForm">
              <div>
                <label className="inp_label">Email or Username</label>
                <input className="signinInp" type="text" value="" />
              </div>
              <div>
                <label className="inp_label">Password</label>
                <input className="signinInp" type="password" value="" />
              </div>
